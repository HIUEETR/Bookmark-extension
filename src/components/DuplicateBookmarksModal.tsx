    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="empty-modal wide-modal" role="dialog" aria-modal="true" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="duplicate-list">
          {groups.length === 0 ? (
            <div className="empty-modal-empty">{t.duplicates.none}</div>
          ) : (
            groups.map((group) => (
        ...
        <div className="empty-modal-actions">
          ...
          <button className="btn btn-danger" onClick={onDelete} disabled={selectedIds.size === 0}>
